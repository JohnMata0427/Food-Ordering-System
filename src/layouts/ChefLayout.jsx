...
export default function ChefLayout() {
    ...
    return (
        <div className="flex">
            <div className="flex h-[100vh] w-[20vw] flex-col bg-black">
                ...
                <nav className="mt-10 px-6">
                    <button
                        className="ounded-lg my-6 flex items-center p-2 text-white transition-colors duration-200 hover:bg-gray-100 hover:text-gray-800"
                        onClick={() => navigate("/chef/add-producto")}
                    >
                        <svg fill="none" viewBox="0 0 24 24" height={"25px"}>
                            <path
                                fill="currentColor"
                                fillRule="evenodd"
                    ...
                    <button
                        className="my-6 flex items-center rounded-lg p-2 text-white transition-colors duration-200 hover:bg-gray-100 hover:text-gray-800"
