...
export default function ChefLayout() {
  ...
  return (
    <div className="flex">
      <div className="flex flex-col w-[20vw] bg-black h-[100vh] pt-10">
        <div className="flex flex-col items-center justify-center">
          <img src={logo} className="h-20" />
          <div>
            <span className="text-gray-100 ml-4 text-2xl font-bold">
              DASHBOARD
            </span>
          </div>
        </div>
        <nav className="mt-10 px-6 ">
          ...
          >
            ...
            <span className="mx-4 text-lg font-normal">Lista de Productos</span>
          ...
          >
            <svg viewBox="0 0 1024 1024" fill="currentColor" height={"25px"}>
