  ...
  return (
    <>
      ...
      <section className="flex flex-col">
        <h1 className="my-4 text-center text-2xl font-bold uppercase">Menú</h1>
        <div className="flex flex-col items-center justify-center gap-8 sm:flex-row">
          {categorias.map((categoria) => (
            <Link
              key={categoria}
              className="w-3/5 hover:scale-105 sm:w-1/4 transition-transform"
            ...
            >
              <article className="rounded-2xl bg-black text-white">
                ...
                <img
                  ...
                  src={`icono-${categoria.toLowerCase()}.png`}
                  alt=""
                />
              </article>
            </Link>
