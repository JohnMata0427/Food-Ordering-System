...
const ActualizarPerfil = () => {
	...
	const handleSubmit = async(e) => {
        ...
        if (Object.values(form).includes(""))
        {
            ...
            setMessage({ respuesta: "Todos los campos deben ser ingresados", tipo: false })
					...
					<div className="flex flex-col items-center gap-y-2">
						...
						>
							<svg className="z-10" width="20" viewBox="0 0 33 40">
								<path
									className="fill-black group-hover:fill-[#DCB50E]"
									id="Vector" d="M29.7219 2.5H5C4.33696 2.5 3.70107 2.76339 3.23223 3.23223C2.76339 3.70107 2.5 4.33696 2.5 5V35C2.5 35.663 2.76339 36.2989 3.23223 36.7678C3.70107 37.2366 4.33696 37.5 5 37.5H35C35.6625 37.4981 36.2973 37.2342 36.7657 36.7657C37.2342 36.2973 37.4981 35.6625 37.5 35V10.2781L29.7219 2.5ZM8.75 13.75V8.75H23.75V13.75H8.75ZM26.243 27.7938C26.1861 29.0036 25.7789 30.1708 25.0709 31.1535C24.363 32.1362 23.3847 32.892 22.2551 33.3291C21.1256 33.7661 19.8934 33.8655 18.7084 33.6153C17.5233 33.365 16.4366 32.7758 15.5802 31.9193C14.7238 31.0628 14.1347 29.976 13.8846 28.791C13.6345 27.6059 13.734 26.3737 14.1712 25.2442C14.6084 24.1147 15.3643 23.1365 16.3471 22.4287C17.3299 21.7208 18.4972 21.3138 19.707 21.257C20.5756 21.2188 21.4426 21.3617 22.253 21.6767C23.0633 21.9917 23.7992 22.4718 24.4139 23.0866C25.0287 23.7014 25.5087 24.4374 25.8236 25.2478C26.1385 26.0582 26.2813 26.9252 26.243 27.7938Z"
								/>
							</svg>
						</CustomButton>
