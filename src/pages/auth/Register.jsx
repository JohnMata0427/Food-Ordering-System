...
export default function Register() {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`${import.meta.env.VITE_BACKEND_URL}/registro`, options)
      .then(() => {
        setEnviar(true);
        setMensaje({
          respuesta: 'Registro exitoso, verifica tu correo electrónico',
          exito: true,
        });
      })
      .catch((error) => {
      ...
      {!enviar ? (
            ...
            <div className="flex w-full flex-col gap-y-4">
              <div className="relative">
                ...
                <input
                  ...
                  maxLength={20}
                />
                <p className="mt-2 hidden text-sm text-pink-700 peer-invalid:block">
              ...
              <label className="relative" htmlFor="telefono">
                ...
                />
                <p className="mt-2 hidden text-sm text-pink-700 peer-invalid:block">
                  Ingrese un número de teléfono válido (ej: 0987654321)
                </p>
              </label>
        ...
        <div className="flex w-full flex-col items-center justify-center md:w-2/5">
          ...
          <span className="my-4 text-center text-sm">
            Revisa tu correo electrónico y haz clic en el enlace para confirmar
