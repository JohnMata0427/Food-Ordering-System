...
export default function Verification() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (verificationCode.length !== 11) {
            setMensaje({ respuesta: "El código de verificación debe tener 11 dígitos", tipo: false });
            return;
        }
        try {
            const url = `${import.meta.env.VITE_BACKEND_URL}/chef/recuperarpassword`;
            const respuesta = await axios.post(url, { email: mail, verificationCode });
