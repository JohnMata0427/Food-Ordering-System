		...
		<>
			<div className="flex flex-col justify-center items-center sm:w-2/5 w-full py-4">
				...
				<div className="flex flex-col items-center gap-y-4 mb-6">
					<h2 className="bg-primary border-primary text-base relative inline-flex items-center justify-center h-11 border-2 border-solid py-0 px-6 rounded-md overflow-hidden  ease-in-out outline-0">
						alan.rios.hd@gmail.com
					</h2>
				</div>
				<h5 className="text-base font-normal mb-6 text-center pt-2 pb-5">
					Para confirmar tu dirección de correo electrónico haz click en el
					siguiente enlace:
				</h5>
