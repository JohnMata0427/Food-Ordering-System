...
export default function ActualizarPerfil() {
    ...
    return (
        <section className="m-8 flex flex-col items-start justify-center gap-x-8 sm:flex-row">
            ...
            <div className="flex w-full flex-col justify-center sm:w-3/5 sm:pl-6">
                ...
                >
                    <div className="flex w-full flex-col gap-y-4">
                        ...
                        <div className="relative">
                            <img
                                className="absolute left-3 top-3 my-auto size-5"
                                src={documentoIcon}
                                alt="Icono de contraseña"
                            />
                            <textarea
                                ...
                                name="trayectoria"
                                type="text"
                                className="text-md h-40 max-h-40 w-full rounded-xl border border-black p-2.5 pl-11 placeholder-slate-700 shadow-md shadow-black/20 hover:border-slate-800"
