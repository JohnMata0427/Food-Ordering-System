			...
			<div className="w-1/2 flex flex-col justify-between py-2 px-4">
				...
				<div className="relative flex items-center">
					<button
						...
						className="bg-black hover:bg-neutral-900 flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-black focus:ring-2 focus:outline-none hover:scale-105"
					>
						<svg
