...
export default function Header() {
	...
	return (
		<header className="relative flex justify-between items-center w-full bg-black border-b-4 border-b-red-700 py-2 px-4">
			...
			<div className="flex items-center justify-end gap-x-4">
				<div className="relative">
					<input
						className="py-1.5 px-4 rounded-2xl w-96 text-sm"
						type="search"
						placeholder="Buscar..."
					/>
					<svg
				...
				{menu && (
					<>
						...
						></div>
						<div className="absolute z-20 top-14 right-8 bg-neutral-200 rounded-lg shadow-lg shadow-black/30">
							<ul className="flex flex-col gap-y-3 py-3 px-5">
								<li>
									<Link
										className="text-black text-sm hover:text-neutral-700  flex gap-x-2 group hover:scale-105 items-center"
										to="/perfil"
										onClick={() => setMenu(false)}
									>
										<svg width="15" viewBox="0 0 417 417">
											<path
												className="group-hover:fill-neutral-700 fill-black"
								...
								<li>
									<button
										...
										className="text-red-700 text-sm hover:text-red-400  flex gap-x-2 group hover:scale-105 items-center"
									>
										<svg width="15" viewBox="0 0 416 352">
											<path
												className="group-hover:fill-red-400 fill-red-700"
