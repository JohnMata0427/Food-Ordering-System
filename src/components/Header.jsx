    ...
    <header className="flex justify-between items-center w-full bg-black border-b-4 border-b-red-700 py-2 px-4">
      <nav className="flex items-center gap-x-16">
        ...
        <ul className="flex gap-x-8">
          <li>
            <Link
              className={`${
                urlActual === "/inicio" ? "text-[#dcb50e]" : "text-white"
              } hover:text-[#dcb50e]`}
              to="/inicio"
            >
              Inicio
          ...
          <li>
            <Link
              className={`${
                urlActual === "/categorias" ? "text-[#dcb50e]" : "text-white"
              } hover:text-[#dcb50e]`}
              to="/categorias"
            >
              Categorias
          ...
          <li>
            <Link
              className={`${
                urlActual === "/ordenar" ? "text-[#dcb50e]" : "text-white"
              } hover:text-[#dcb50e]`}
              to="/ordenar"
            >
              Ordenar
          ...
          <li>
            <Link
              className={`${
                urlActual === "/contacto" ? "text-[#dcb50e]" : "text-white"
              } hover:text-[#dcb50e]`}
              to="/contacto"
            >
              Contacto
      ...
      <div className="flex items-center justify-end gap-x-4">
        ...
        <Link
          ...
          } group hover:text-[#dcb50e] flex items-center gap-x-2 p-2`}
          to="/perfil"
        >
        ...
        <button
          className={`${
            urlActual === "/cerrar-sesion"
              ? "text-[#dcb50e]"
              : "text-white"
          } hover:text-[#dcb50e] flex items-center gap-x-2 p-2`}
          onClick={() => {
